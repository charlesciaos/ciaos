...
var getFunctionsUrl = "http://charlesciaos.diskstation.me/api/commandSuggest.php?keyword=";
/* URL for seeing the results for the selected suggestion */
var phpHelpUrl="http://charlesciaos.diskstation.me/?action=";
...
{  
  ...
  oContent.addEventListener("click", hideSuggestions);
  ...
  oKeyword.addEventListener("click", handleKeyUp);
...
{  
  ...
  var oScroll = document.getElementById("scrolls");
  ...
  if (e.type == "keyup") 
  {
    ...
    // if the down arrow is pressed we go to the next suggestion
      ...
      {                   
        ...
        {   
          oScroll = document.getElementById("scrolls");
...
function updateKeywordValue(oTr)
{
  ...
  //console.log("oKeyword.value: "+oKeyword.value);
}
